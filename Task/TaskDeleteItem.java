...
public class TaskDeleteItem  extends AsyncTask<String, Void, String> {
    private Item item;

    public TaskDeleteItem(Item item) {
        this.item = item;
    }
    ...
    protected String doInBackground(String... strings) {
        ...
        String url_base = "http://10.0.2.2:8080/delete";    // server address
